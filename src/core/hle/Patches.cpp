...
std::map<const std::string, const xbox_patch_t> g_PatchTable = {
	...
	PATCH_ENTRY("JvsBACKUP_Write2", XTL::EMUPATCH(JvsBACKUP_Write), PATCH_ALWAYS),
	...
	PATCH_ENTRY("JvsEEPROM_Read3", XTL::EMUPATCH(JvsEEPROM_Read), PATCH_ALWAYS),
	...
	PATCH_ENTRY("JvsEEPROM_Write3", XTL::EMUPATCH(JvsEEPROM_Write), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareDownload", XTL::EMUPATCH(JvsFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareDownload2", XTL::EMUPATCH(JvsFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareDownload3", XTL::EMUPATCH(JvsFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareDownload4", XTL::EMUPATCH(JvsFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareUpload", XTL::EMUPATCH(JvsFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareUpload2", XTL::EMUPATCH(JvsFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareUpload3", XTL::EMUPATCH(JvsFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsFirmwareUpload4", XTL::EMUPATCH(JvsFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsNodeReceivePacket", XTL::EMUPATCH(JvsNodeReceivePacket), PATCH_ALWAYS),
	PATCH_ENTRY("JvsNodeReceivePacket2", XTL::EMUPATCH(JvsNodeReceivePacket), PATCH_ALWAYS),
	PATCH_ENTRY("JvsNodeSendPacket", XTL::EMUPATCH(JvsNodeSendPacket), PATCH_ALWAYS),
	PATCH_ENTRY("JvsNodeSendPacket2", XTL::EMUPATCH(JvsNodeSendPacket), PATCH_ALWAYS),
	PATCH_ENTRY("JvsRTC_Read", XTL::EMUPATCH(JvsRTC_Read), PATCH_ALWAYS),
	PATCH_ENTRY("JvsRTC_Read2", XTL::EMUPATCH(JvsRTC_Read), PATCH_ALWAYS),
	PATCH_ENTRY("JvsRTC_Read3", XTL::EMUPATCH(JvsRTC_Read), PATCH_ALWAYS),
	PATCH_ENTRY("JvsRTC_Write", XTL::EMUPATCH(JvsRTC_Write), PATCH_ALWAYS),
	PATCH_ENTRY("JvsRTC_Write2", XTL::EMUPATCH(JvsRTC_Write), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareDownload", XTL::EMUPATCH(JvsScFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareDownload2", XTL::EMUPATCH(JvsScFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareDownload3", XTL::EMUPATCH(JvsScFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareDownload4", XTL::EMUPATCH(JvsScFirmwareDownload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareUpload", XTL::EMUPATCH(JvsScFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareUpload2", XTL::EMUPATCH(JvsScFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScFirmwareUpload3", XTL::EMUPATCH(JvsScFirmwareUpload), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScReceiveMidi", XTL::EMUPATCH(JvsScReceiveMidi), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScReceiveMidi2", XTL::EMUPATCH(JvsScReceiveMidi), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScReceiveRs323c", XTL::EMUPATCH(JvsScReceiveRs323c), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScReceiveRs323c2", XTL::EMUPATCH(JvsScReceiveRs323c), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScSendMidi", XTL::EMUPATCH(JvsScSendMidi), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScSendMidi2", XTL::EMUPATCH(JvsScSendMidi), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScSendRs323c", XTL::EMUPATCH(JvsScSendRs323c), PATCH_ALWAYS),
	PATCH_ENTRY("JvsScSendRs323c2", XTL::EMUPATCH(JvsScSendRs323c), PATCH_ALWAYS),
};
