...
void NVNetDevice::Init()
{
	...
	NvNetState.regs[NvRegMacAddrA + 0] = m_GuestMacAddress.bytes[0];
	NvNetState.regs[NvRegMacAddrA + 1] = m_GuestMacAddress.bytes[1];
	NvNetState.regs[NvRegMacAddrA + 2] = m_GuestMacAddress.bytes[2];
	NvNetState.regs[NvRegMacAddrA + 3] = m_GuestMacAddress.bytes[3];
	NvNetState.regs[NvRegMacAddrB + 0] = m_GuestMacAddress.bytes[4];
	NvNetState.regs[NvRegMacAddrB + 1] = m_GuestMacAddress.bytes[5];
